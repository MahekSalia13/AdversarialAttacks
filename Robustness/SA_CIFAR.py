...
class robust_simannealer(Annealer):
    ...
    def energy(self):
        ...
        model = AlexNet_CIFAR(num_classes=10, states_=self.state).to(device)
...
if __name__ == '__main__':
    ...
    for atk_eps_ in atk_eps_s:
        ch_size_1 = LAYERS * 3  # The size of the initial state vector
